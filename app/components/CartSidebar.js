            ...
            items.map(item => (
              <div key={item.id} className="flex gap-4 border border-white/[0.05] p-4 bg-[#0a0a0a]">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  {item.teamName && (
                    <div className="font-mono-custom text-[9px] text-white/30 mb-1">{item.teamName} Edition</div>
                  )}
                  {item.size && (
                    <div className="font-mono-custom text-[9px] text-white/30 mb-1">SIZE: {item.size}</div>
                  )}
